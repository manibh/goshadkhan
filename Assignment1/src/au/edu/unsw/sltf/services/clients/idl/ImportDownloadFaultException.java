...
public class ImportDownloadFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1367554283241L;
    
    private au.edu.unsw.sltf.services.clients.idl.ImportDownloadServicesStub.ImportDownloadFault faultMessage;
    ...
    public void setFaultMessage(au.edu.unsw.sltf.services.clients.idl.ImportDownloadServicesStub.ImportDownloadFault msg){
       faultMessage = msg;
    }
    
    public au.edu.unsw.sltf.services.clients.idl.ImportDownloadServicesStub.ImportDownloadFault getFaultMessage(){
       return faultMessage;
    }
}
