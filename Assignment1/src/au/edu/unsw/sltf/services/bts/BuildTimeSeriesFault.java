 ...
 */
            ...
            /**
            *  BuildTimeSeriesFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BuildTimeSeriesFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://sltf.unsw.edu.au/services",
                "buildTimeSeriesFault",
                "ns1");
                        ...
                        */
                                    ...
                                    protected au.edu.unsw.sltf.services.bts.TimeSeriesFaultType localFaultType ;
                                

                           /**
                           * Auto generated getter method
                           * @return au.edu.unsw.sltf.services.bts.TimeSeriesFaultType
                           */
                           public  au.edu.unsw.sltf.services.bts.TimeSeriesFaultType getFaultType(){
                            ...
                            /**
                               ...
                               */
                               public void setFaultType(au.edu.unsw.sltf.services.bts.TimeSeriesFaultType param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":buildTimeSeriesFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "buildTimeSeriesFault",
    ...
    public static class Factory{
        ...
        */
        public static BuildTimeSeriesFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BuildTimeSeriesFault object =
                new BuildTimeSeriesFault();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"buildTimeSeriesFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BuildTimeSeriesFault)au.edu.unsw.sltf.services.bts.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://sltf.unsw.edu.au/services","faultType").equals(reader.getName())){
                                                ...
                                                object.setFaultType(au.edu.unsw.sltf.services.bts.TimeSeriesFaultType.Factory.parse(reader));
