 ...
 */
            ...
            /**
            *  BuildTimeSeriesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BuildTimeSeriesResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":buildTimeSeriesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "buildTimeSeriesResponse",
    ...
    public static class Factory{
        ...
        */
        public static BuildTimeSeriesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BuildTimeSeriesResponse object =
                new BuildTimeSeriesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"buildTimeSeriesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BuildTimeSeriesResponse)au.edu.unsw.sltf.services.bts.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
